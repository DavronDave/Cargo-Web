    ...
    <div class="container">
        ...
        <div class="clients-slider owl-carousel owl-theme pt-45">
            <div class="clients-content">
                <div class="content">
                    <img src="{{asset('site/assets/images/countries-img/countries-img1.jpg')}}" alt="Images">
            ...
            <div class="clients-content">
                <div class="content">
                    <img src="{{asset('site/assets/images/countries-img/countries-img2.jpg')}}" alt="Images">
                    <i class='bx bxs-quote-alt-left'></i>
                    <h3>Alin Decros</h3>
            ...
            <div class="clients-content">
                <div class="content">
                    <img src="{{asset('site/assets/images/countries-img/countries-img3.jpg')}}" alt="Images">
                    <i class='bx bxs-quote-alt-left'></i>
                    <h3>Elen Musk</h3>
