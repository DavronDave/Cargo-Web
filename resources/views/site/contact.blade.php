...
=======
                        <form action="{{route('site.contact.store')}}" method="post" id="contactForm" enctype="multipart/form-data">
>>>>>>> 85c4a94b22db20bdf13bbfdc8fb5953af05c5c3b
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
...
{{--
                                <div class="col-lg-12 col-md-12">
                                    <div class="agree-label">
                                        ...
                                        <label for="chb1">
                                            Accept <a href="privacy-policy.html">Privacy Policy.</a>
                                        </label>
                                    </div>
                                </div>
--}}
