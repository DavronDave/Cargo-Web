                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="footer-widget">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="{{asset('site/assets/images/logos/footer-logo.png')}}" alt="Images">
                            </a>
                        </div>
                        <p>
                        ...
                        <ul class="footer-blog">
                            <li>
                                <a href="blog-details.html">
                                    <img src="{{asset('site/assets/images/blog/blog-img-footer.jpg')}}" alt="Images">
                                </a>
                                <div class="content">
                            ...
                            <li>
                                <a href="blog-details.html">
                                    <img src="{{asset('site/assets/images/blog/blog-img-footer2.jpg')}}" alt="Images">
                                </a>
                                <div class="content">
                            ...
                            <li>
                                <a href="blog-details.html">
                                    <img src="{{asset('site/assets/images/blog/blog-img-footer3.jpg')}}" alt="Images">
                                </a>
                                <div class="content">
