...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-play">
                        <img src="{{asset('site/assets/images/about/about-img1.jpg')}}" alt="About Images">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="choose-img">
                        <img src="{{asset('site/assets/images/choose-img.jpg')}}" alt="Images">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row pt-45">
                <div class="col-lg-4 col-sm-6">
                    <div class="security-card">
                        ...
                        <h3><a href="portfolio-details.html">Business Security</a></h3>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="security-card">
                        ...
                        <h3><a href="portfolio-details.html">Manage IT Service</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam blandit scelerisque ullamcorper proin scelerisque tortor odio.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="security-card">
                        ...
                        <h3><a href="portfolio-details.html">Product Analysis</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam blandit scelerisque ullamcorper proin scelerisque tortor odio.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="security-card">
                        ...
                        <h3><a href="portfolio-details.html">Analytic Solution</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam blandit scelerisque ullamcorper proin scelerisque tortor odio.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="security-card">
                        ...
                        <h3><a href="portfolio-details.html">Finest Quality</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam blandit scelerisque ullamcorper proin scelerisque tortor odio.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="security-card">
                        ...
                        <h3><a href="portfolio-details.html">Risk Management</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam blandit scelerisque ullamcorper proin scelerisque tortor odio.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="brand-slider owl-carousel owl-theme">
                <div class="brand-item">
                    <img src="{{asset('site/assets/images/brand-logo/brand-style1.png')}}" alt="Images">
                </div>
                <div class="brand-item">
                    <img src="{{asset('site/assets/images/brand-logo/brand-style2.png')}}" alt="Images">
                </div>
                <div class="brand-item">
                    <img src="{{asset('assets/images/brand-logo/brand-style3.png')}}" alt="Images">
                </div>
                <div class="brand-item">
                    <img src="{{asset('site/assets/images/brand-logo/brand-style4.png')}}" alt="Images">
                </div>
                <div class="brand-item">
                    <img src="{{asset('site/assets/images/brand-logo/brand-style5.png')}}" alt="Images">
                </div>
                <div class="brand-item">
                    <img src="{{asset('site/assets/images/brand-logo/brand-style3.png')}}" alt="Images">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="counter-area pt-100 pb-70">
        ...
        <div class="counter-shape">
            <div class="shape1">
                <img src="{{asset('site/assets/images/shape/shape1.png')}}" alt="Images">
            </div>
            <div class="shape2">
                <img src="{{asset('site/assets/images/shape/shape2.png')}}" alt="Images">
            </div>
        </div>
    </div>
    <!-- Counter Area End -->
