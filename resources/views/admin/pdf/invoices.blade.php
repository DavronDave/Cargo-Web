...
<head>
    ...
    @foreach($invoices as $invoice)
        @php
            $invoice_products = \App\Models\InvoiceProduct::with('invoice', 'product')
                ...
                <div class="details">
                    ...
                    <table>
                        ...
                        @foreach($invoice_products as $invoice_product)
                            <tr>
{{--                                @dd($invoice_product->product->name)--}}
                                <td>{{ $counter }}</td>
                                <td class="product-name-value" style="margin-left: 15px !important;"> {{$invoice_product->product->name}}</td>
