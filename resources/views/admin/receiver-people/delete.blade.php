<div class="modal fade" id="modal-dialog-delete{{$receiverPerson->id}}" style="display: none;">
    <div class="modal-dialog">
        <form action="{{route('admin.driver-receiver.destroy', ['driver' => $driver->id, 'receiver' => $receiverPerson->id])}}" method="post" >
            @method('DELETE')
            @csrf
