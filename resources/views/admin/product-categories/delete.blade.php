<div class="modal fade" id="modal-dialog-delete{{$productCategory->id}}" style="display: none;">
    <div class="modal-dialog">
        <form action="{{route('admin.product-categories.destroy', ['product_category' => $productCategory->id])}}" method="post" >
            @method('DELETE')
            @csrf
