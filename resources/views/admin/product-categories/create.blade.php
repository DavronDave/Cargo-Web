                ...
                <form enctype="multipart/form-data" id="add_productCategories">
                    @csrf
                        <div class="row">
                            <div class="col-md-12 ui-sortable">
                                <div class="form-group" >
                                    <label for="create_name">Категория продукта</label>
                        ...
                        <div class="row">
                            <div class="col-md-12 ui-sortable">
                                <div class="form-group" >
                                    <label for="create_code">Код продукта</label>
                                    <input type="number" name="code" id="create_code" placeholder="Введите код продукта" class="form-control">
                                </div>
                            </div>
                        </div>
