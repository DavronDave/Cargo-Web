<div class="modal fade" id="modal-dialog-delete{{$senderPerson->id}}" style="display: none;">
    <div class="modal-dialog">
        <form action="{{route('admin.sender-people.destroy', ['sender_person' => $senderPerson->id])}}" method="post" >
            @method('DELETE')
            @csrf
