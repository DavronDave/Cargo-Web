                            ...
                            <div class="row">
                                <div class="col-md-12 ui-sortable">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="create_name_{{$language->url}}" name="name[{{$language->url}}]" value ="{{old('name')}}"
                                        placeholder="Введите полное Заголовок" class="form-control create_error">
                                    </div>
                                </div>
                            </div>
                        </div>
