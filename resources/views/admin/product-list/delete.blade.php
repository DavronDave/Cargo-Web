<div class="modal fade" id="modal-dialog-delete{{$product->id}}" style="display: none;">
    <div class="modal-dialog">
        <form action="{{route('admin.product-list.destroy', ['product_list' => $product])}}" method="post" >
            @method('DELETE')
            @csrf
