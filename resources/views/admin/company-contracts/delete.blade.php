<div class="modal fade" id="modal-dialog-delete{{$company->id}}" style="display: none;">
    <div class="modal-dialog">
        <form action="{{route('admin.company-contracts.destroy', ['company_contract' => $company->id])}}" method="post" >
            @method('DELETE')
            @csrf
